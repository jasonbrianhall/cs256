...
// Part 6 - Added functionalities :
//               - creating three embeded circles
//               - each circle has a word written inside
//               - each word has a different style and size								     // Borland C++ - (C) Copyright 1991 by Borland International
